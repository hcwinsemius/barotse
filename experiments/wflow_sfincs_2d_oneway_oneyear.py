...
config_fn = os.path.join(root_dir, 'wflow_sfincs_2d_oneway.ini')
...
timesteps = 10
#timesteps = 365
cbmi.logger.info('Running 2d experiment for {:d} timesteps'.format(timesteps))
...
SFINCS_outputs = ['SGCQin', 'H', 'H_f', 'H_c', 'Qx', 'Qy']
